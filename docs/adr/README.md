...
| [0027](0027-hugo-website-on-github-pages.md) | The website is a hand-written Hugo site in `site/`, deployed to GitHub Pages by a workflow, and presents only the software, installation, and usage | Accepted |
