...
| [0027](0027-static-single-page-website-on-github-pages.md) | The website is one hand-written static page in `site/`, deployed to GitHub Pages by a workflow, presenting only the software, installation, and usage | Accepted |
